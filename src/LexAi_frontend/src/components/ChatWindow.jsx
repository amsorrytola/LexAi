      ...
      {messages.length === 0 && !loading ? (
        <div className="h-full flex items-center justify-center">
          <div className="text-center max-w-md mx-auto px-4">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-2">Ready to Help!</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-sm mx-auto">
              <div className="bg-white p-3 rounded-lg shadow-sm border border-gray-200">
                <div className="text-blue-600 text-sm font-medium">💡 Ask questions</div>
                <div className="text-xs text-gray-500 mt-1">Get answers and explanations</div>
              </div>
              <div className="bg-white p-3 rounded-lg shadow-sm border border-gray-200">
                <div className="text-purple-600 text-sm font-medium">🛠️ Get help</div>
                <div className="text-xs text-gray-500 mt-1">Solve problems together</div>
              </div>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className={`max-w-2xl ${msg.role === "user" ? "order-first" : ""}`}>
                <div className="flex items-center space-x-2 mb-1">
                  ...
                  <span className="text-xs text-gray-500">{dayjs(msg.timestamp).format("HH:mm")}</span>
                </div>
                <div
