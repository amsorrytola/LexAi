...
import { idlFactory } from './LexAi_frontend.did.js';
export { idlFactory } from './LexAi_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LEXAI_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./LexAi_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the LexAi_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./LexAi_frontend.did.js")._SERVICE>}
 */
export const LexAi_frontend = createActor(canisterId);
