...
import { idlFactory } from './LexAi_backend.did.js';
export { idlFactory } from './LexAi_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LEXAI_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./LexAi_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the LexAi_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./LexAi_backend.did.js")._SERVICE>}
 */
export const LexAi_backend = createActor(canisterId);
